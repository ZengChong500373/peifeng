...
public class NotificationBadge {
    ...
    private static boolean initBadger() {
        ...
        if (badger == null) {
            if (DeviceInfo.manufacturer.equalsIgnoreCase("Xiaomi")) {
                badger = new XiaomiHomeBadger();
            } else if (DeviceInfo.manufacturer.equalsIgnoreCase("ZUK")) {
                badger = new ZukHomeBadger();
            } else if (DeviceInfo.manufacturer.equalsIgnoreCase("OPPO")) {
                badger = new OPPOHomeBader();
            } else if (DeviceInfo.manufacturer.equalsIgnoreCase("VIVO")) {
