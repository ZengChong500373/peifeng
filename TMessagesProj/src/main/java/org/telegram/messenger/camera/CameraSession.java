...
public class CameraSession {
    ...
    protected void configureRoundCamera() {
        try {
            ...
            if (camera != null) {
                ...
                if ("samsung".equals(DeviceInfo.manufacturer) && "sf2wifixx".equals(Build.PRODUCT)) {
    ...
    private int getHigh() {
        if ("LGE".equals(DeviceInfo.manufacturer) && "g3_tmo_us".equals(Build.PRODUCT)) {
    ...
    private int getDisplayOrientation(Camera.CameraInfo info, boolean isStillCapture) {
        ...
        if (info.facing == Camera.CameraInfo.CAMERA_FACING_FRONT) {
            ...
            if (!isStillCapture && "Huawei".equals(DeviceInfo.manufacturer) && "angler".equals(Build.PRODUCT) && displayOrientation == 270) {
