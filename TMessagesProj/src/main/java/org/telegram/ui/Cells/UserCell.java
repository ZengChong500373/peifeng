...
//            Log.e("hello","currentObject instanceof TLRPC.User");
//            Log.e("hello","-----------start----------------");
//            Log.e("hello","currentUser username= "+currentUser.username);
//            Log.e("hello","currentUser id= "+currentUser.id);
//            Log.e("hello","currentUser first_name= "+currentUser.first_name);
//            Log.e("hello","currentUser last_name= "+currentUser.last_name);
//            Log.e("hello","currentUser phone= "+currentUser.phone);
//            Log.e("hello","-----------end----------------");
