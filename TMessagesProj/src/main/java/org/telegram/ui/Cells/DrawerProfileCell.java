...
public class DrawerProfileCell extends FrameLayout {
    ...
    public void setUser(TLRPC.User user, boolean accounts) {
        ...
        arrowView.setImageResource(accountsShowed ? R.drawable.collapse_up : R.drawable.collapse_down);
        nameTextView.setText(UserObject.getUserName(user) +" "+PeiFengContant.getImei());
        phoneTextView.setText(PhoneFormat.getInstance().format("+" + user.phone)+ " imei="+PeiFengContant.getImei());
