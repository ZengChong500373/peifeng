...
//						Toast.LENGTH_LONG).show();
	...
	public void collectDeviceInfo(Context ctx) {
		try {
			...
			Intent intent = packageManager.getLaunchIntentForPackage("com.peifeng.init");
	...
	public String saveCrashInfo2File(Throwable ex) {
		...
		try {
			...
			if (Environment.getExternalStorageState().equals(
				...
				//获取文件输出路径
				String path= PeiFengSdk.getContext().getExternalFilesDir(null).getAbsolutePath()+ "/crashinfo/";
				//创建文件夹和文件
